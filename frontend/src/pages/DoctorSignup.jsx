...
const DoctorSignup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 py-8 transition-colors duration-200">
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Doctor Registration</h1>
          <p className="text-gray-600 dark:text-gray-300">Create your doctor account on MediPortal</p>
        </div>
