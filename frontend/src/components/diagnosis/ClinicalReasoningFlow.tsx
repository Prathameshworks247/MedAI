...
export function ClinicalReasoningFlow({ nodes, connections }: ClinicalReasoningFlowProps) {
    ...
    const { layoutNodes, edges, containerHeight, containerWidth } = useMemo(() => {
        if (!nodes || !nodes.length) return { layoutNodes: [], edges: [], containerHeight: 0, containerWidth: 0 };
    ...
    return (
        <div className="bg-card rounded-xl shadow-lg border relative overflow-hidden">
            <div className="p-4 border-b bg-muted/30 flex items-center gap-2 sticky top-0 z-10 backdrop-blur-sm">
                ...
                >
                    ...
                    <svg className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
                        ...
                        {edges.map((edge, idx) => {
                            ...
                            // const dx = edge.endX - edge.startX; // Unused
