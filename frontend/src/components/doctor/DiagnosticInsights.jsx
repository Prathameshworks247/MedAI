...
import { diagnosticInsights } from '../../data/dummyData';
      ...
      <div className="card mb-6">
        <div className="flex items-start space-x-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 leading-relaxed">{diagnosticInsights.summary}</p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex items-center space-x-3">
                <div className={`font-bold text-lg ${
                  index === 0 ? 'text-purple-700' : 'text-gray-600'
                }`}>
                  #{index + 1}
                </div>
                <div className="flex-1">
