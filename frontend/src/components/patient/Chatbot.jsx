...
const Chatbot = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Health Assistant Chatbot</h2>
        <p className="text-gray-600">Ask questions about your medications, diet, and care plan</p>
      </div>
      ...
      <div className="card mb-6 bg-blue-50 border-2 border-blue-200">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-blue-900 mb-1">AI-Powered Assistant</h3>
